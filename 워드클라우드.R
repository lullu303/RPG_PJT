...
# 전체 url
#url = "https://search.naver.com/search.naver?where=news&sm=tab_pge&query=%EC%BD%98%EC%86%94%EA%B2%8C%EC%9E%84&sort=0&photo=0&field=0&pd=13&ds=2023.02.10&de=2023.05.11&cluster_rank=65&mynews=0&office_type=0&office_section_code=0&news_office_checked=&nso=so:r,p:3m,a:all&start=1"
...
PAGE <- seq(from=1, by=10, length.out=50)
